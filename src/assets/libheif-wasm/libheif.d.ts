...
interface WasmModule {
  ...
  _heif_tai_timestamp_packet_alloc(): number;
  _heif_tai_timestamp_packet_copy(_0: number, _1: number): void;
  _heif_tai_timestamp_packet_release(_0: number): void;
  ...
  _heif_image_get_plane_readonly2(_0: number, _1: number, _2: number): number;
  ...
  _heif_string_release(_0: number): void;
  ...
  _heif_image_extract_area(_0: number, _1: number, _2: number, _3: number, _4: number, _5: number, _6: number, _7: number): void;
  ...
  _heif_image_get_plane2(_0: number, _1: number, _2: number): number;
  ...
  _heif_image_handle_set_pixel_aspect_ratio(_0: number, _1: number, _2: number): void;
  ...
  _heif_image_add_plane_safe(_0: number, _1: number, _2: number, _3: number, _4: number, _5: number, _6: number): void;
  ...
  _heif_color_conversion_options_ext_alloc(): number;
  _heif_color_conversion_options_ext_copy(_0: number, _1: number): void;
  _heif_color_conversion_options_ext_free(_0: number): void;
  ...
  _heif_image_handle_set_content_light_level(_0: number, _1: number): void;
  ...
  _heif_image_handle_set_mastering_display_colour_volume(_0: number, _1: number): void;
  ...
  _heif_item_get_property_extended_language(_0: number, _1: number, _2: number, _3: number): void;
  _heif_item_set_property_extended_language(_0: number, _1: number, _2: number, _3: number, _4: number): void;
  ...
  _heif_context_has_sequence(_0: number): number;
  _heif_context_get_sequence_timescale(_0: number): number;
  _heif_context_get_sequence_duration(_0: number): BigInt;
  _heif_track_release(_0: number): void;
  _heif_context_number_of_sequence_tracks(_0: number): number;
  _heif_context_get_track_ids(_0: number, _1: number): void;
  _heif_track_get_id(_0: number): number;
  _heif_context_get_track(_0: number, _1: number): number;
  _heif_track_get_track_handler_type(_0: number): number;
  _heif_track_get_auxiliary_info_type(_0: number): number;
  _heif_track_get_auxiliary_info_type_urn(_0: number): number;
  _heif_track_has_alpha_channel(_0: number): number;
  _heif_track_get_timescale(_0: number): number;
  _heif_track_get_image_resolution(_0: number, _1: number, _2: number, _3: number): void;
  _heif_track_decode_next_image(_0: number, _1: number, _2: number, _3: number, _4: number, _5: number): void;
  _heif_decoding_options_alloc(): number;
  _heif_decoding_options_copy(_0: number, _1: number): void;
  _heif_decoding_options_free(_0: number): void;
  _heif_image_get_duration(_0: number): number;
  _heif_track_get_sample_entry_type_of_first_cluster(_0: number): number;
  _heif_track_get_urim_sample_entry_uri_of_first_cluster(_0: number, _1: number, _2: number): void;
  _heif_track_get_next_raw_sequence_sample(_0: number, _1: number, _2: number): void;
  _heif_raw_sequence_sample_release(_0: number): void;
  _heif_raw_sequence_sample_get_data(_0: number, _1: number): number;
  _heif_raw_sequence_sample_get_data_size(_0: number): number;
  _heif_raw_sequence_sample_get_duration(_0: number): number;
  _heif_context_set_sequence_timescale(_0: number, _1: number): void;
  _heif_context_set_number_of_sequence_repetitions(_0: number, _1: number): void;
  _heif_track_options_alloc(): number;
  _heif_track_options_release(_0: number): void;
  _heif_tai_clock_info_release(_0: number): void;
  _heif_track_options_set_timescale(_0: number, _1: number): void;
  _heif_track_options_set_interleaved_sample_aux_infos(_0: number, _1: number): void;
  _heif_track_options_enable_sample_tai_timestamps(_0: number, _1: number, _2: number, _3: number): void;
  _heif_tai_clock_info_alloc(): number;
  _heif_tai_clock_info_copy(_0: number, _1: number): void;
  _heif_track_options_enable_sample_gimi_content_ids(_0: number, _1: number): void;
  _heif_track_options_set_gimi_track_id(_0: number, _1: number): void;
  _heif_sequence_encoding_options_alloc(): number;
  _heif_sequence_encoding_options_release(_0: number): void;
  _heif_context_add_visual_sequence_track(_0: number, _1: number, _2: number, _3: number, _4: number, _5: number, _6: number, _7: number): void;
  _heif_image_set_duration(_0: number, _1: number): void;
  _heif_track_encode_end_of_sequence(_0: number, _1: number, _2: number): void;
  _heif_track_encode_sequence_image(_0: number, _1: number, _2: number, _3: number, _4: number): void;
  _heif_context_add_uri_metadata_sequence_track(_0: number, _1: number, _2: number, _3: number, _4: number): void;
  _heif_raw_sequence_sample_alloc(): number;
  _heif_raw_sequence_sample_set_data(_0: number, _1: number, _2: number, _3: number): void;
  _heif_raw_sequence_sample_set_duration(_0: number, _1: number): void;
  _heif_track_add_raw_sequence_sample(_0: number, _1: number, _2: number): void;
  _heif_track_get_number_of_sample_aux_infos(_0: number): number;
  _heif_track_get_sample_aux_info_types(_0: number, _1: number): void;
  _heif_track_get_gimi_track_content_id(_0: number): number;
  _heif_image_get_gimi_sample_content_id(_0: number): number;
  _heif_raw_sequence_sample_get_gimi_sample_content_id(_0: number): number;
  _heif_image_set_gimi_sample_content_id(_0: number, _1: number): void;
  _heif_raw_sequence_sample_set_gimi_sample_content_id(_0: number, _1: number): void;
  _heif_raw_sequence_sample_has_tai_timestamp(_0: number): number;
  _heif_raw_sequence_sample_get_tai_timestamp(_0: number): number;
  _heif_raw_sequence_sample_set_tai_timestamp(_0: number, _1: number): void;
  _heif_track_get_tai_clock_info_of_first_cluster(_0: number): number;
  _heif_track_add_reference_to_track(_0: number, _1: number, _2: number): void;
  _heif_track_get_number_of_track_reference_types(_0: number): number;
  _heif_track_get_track_reference_types(_0: number, _1: number): void;
  _heif_track_get_number_of_track_reference_of_type(_0: number, _1: number): number;
  _heif_track_get_references_from_track(_0: number, _1: number, _2: number): number;
  _heif_track_find_referring_tracks(_0: number, _1: number, _2: number, _3: number): number;
  _heif_item_set_property_tai_clock_info(_0: number, _1: number, _2: number, _3: number, _4: number): void;
  _heif_item_get_property_tai_clock_info(_0: number, _1: number, _2: number, _3: number): void;
  _heif_item_set_property_tai_timestamp(_0: number, _1: number, _2: number, _3: number, _4: number): void;
  _heif_item_get_property_tai_timestamp(_0: number, _1: number, _2: number, _3: number): void;
  _heif_image_set_tai_timestamp(_0: number, _1: number, _2: number): void;
  _heif_image_get_tai_timestamp(_0: number, _1: number, _2: number): void;
  ...
  _heif_metadata_compression_method_supported(_0: number): number;
  ...
  _heif_encoding_options_copy(_0: number, _1: number): void;
  ...
  _heif_context_set_major_brand(_0: number, _1: number): void;
  ...
  _heif_image_handle_get_gimi_content_id(_0: number): number;
  ...
  _heif_unci_image_parameters_alloc(): number;
  _heif_unci_image_parameters_copy(_0: number, _1: number): void;
  _heif_unci_image_parameters_release(_0: number): void;
  _heif_context_add_empty_unci_image(_0: number, _1: number, _2: number, _3: number, _4: number, _5: number): void;
  _heif_image_handle_add_text_item(_0: number, _1: number, _2: number, _3: number, _4: number): void;
  _heif_text_item_release(_0: number): void;
  _heif_image_handle_get_number_of_text_items(_0: number): number;
  _heif_image_handle_get_list_of_text_item_ids(_0: number, _1: number, _2: number): number;
  _heif_context_get_text_item(_0: number, _1: number, _2: number, _3: number): void;
  _heif_text_item_get_id(_0: number): number;
  _heif_text_item_get_content(_0: number): number;
  _heif_text_item_get_property_extended_language(_0: number, _1: number, _2: number): void;
  _heif_text_item_set_extended_language(_0: number, _1: number, _2: number, _3: number): void;
  ...
  _de265_get_image_user_data(_0: number): number;
...
export interface heif_context extends ClassHandle {
}

export interface heif_image_handle extends ClassHandle {
}

export interface heif_image extends ClassHandle {
}
...
interface EmbindModule {
  ...
  heif_context: {};
  heif_context_alloc(): heif_context | null;
  heif_image_handle: {};
  heif_image: {};
  heif_context_free(_0: heif_context | null): void;
  heif_image_handle_release(_0: heif_image_handle | null): void;
  heif_image_release(_0: heif_image | null): void;
  heif_context_get_number_of_top_level_images(_0: heif_context | null): number;
  ...
  heif_image_handle_has_alpha_channel(_0: heif_image_handle | null): number;
  heif_image_handle_is_premultiplied_alpha(_0: heif_image_handle | null): number;
  ...
  heif_item_get_item_type(_0: heif_context | null, _1: number): any;
  heif_item_get_mime_item_content_type(_0: heif_context | null, _1: number): any;
  heif_item_get_mime_item_content_encoding(_0: heif_context | null, _1: number): any;
  heif_item_get_uri_item_uri_type(_0: heif_context | null, _1: number): any;
  heif_item_get_item_name(_0: heif_context | null, _1: number): any;
...
/** 解码后的图像通道数据 */
export interface HeifImageChannel {
  id: heif_channel;
  width: number;
  height: number;
  stride: number;
...
export interface HeifDecodeResult {
  image: heif_image | null;
  channels: HeifImageChannel[];
  code?: heif_error_code;
}

export interface HeifImage {
  /** 内部 image handle */
  handle: heif_image_handle | null;
  /** 获取图像宽度 */
  get_width(): number;
  /** 获取图像高度 */
  get_height(): number;
  ...
  /**
   * 解码并显示图像到 ImageData
   * @param imageData - 目标 ImageData 对象
   * @param callback - 完成回调，接收处理后的 ImageData 或 null
   */
...
export interface HeifDecoder {
  /**
   * 解码 HEIC/HEIF 图像数据
   * @param buffer - HEIC/HEIF 文件的 Uint8Array 数据
   * @returns 解码后的 HeifImage 数组
   */
  decode(buffer: Uint8Array): HeifImage[];
}

interface ExtendedEmbindModule extends EmbindModule {
  /** HeifImage 构造函数 */
  HeifImage: typeof HeifImage;
  /** HeifDecoder 构造函数 */
  HeifDecoder: new () => HeifDecoder;
  /** FourCC 编码工具函数 */
  fourcc(s: string): number;
}

export type MainModule = WasmModule & ExtendedEmbindModule;
